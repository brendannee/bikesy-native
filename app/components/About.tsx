          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView>
              ...
              <Text style={styles.paragraph}>
                Welcome to Bikesy – an innovative and open bike mapping system specially designed to
                find flat, safe, and fast routes anywhere in the SF Bay Area.
              </Text>
              ...
              <Text style={styles.paragraph}>
                ...
                the shortest and steepest. It’s easy to choose among three hill tolerances and three
                levels of safety (safe, safer, and safest) to find a path that’s right for you.
              </Text>
              <Text style={styles.sectionTitle}>We’re serious about open source.</Text>
              <Text style={styles.paragraph}>
                This part is a little geeky, but our back-end and front-end code is completely open.
                Plus, all our data is from OpenStreetMap, so you can edit the underlying map if you
                think we’ve got it wrong. Don’t like what we’ve done? Take our code and do it
                yourself! Or use our API to power your own app.
              </Text>
              <Text style={styles.sectionTitle}>Wait, who are you?</Text>
              <Text style={styles.paragraph}>
                Bikesy was started by{' '}
                <Text onPress={() => Linking.openURL('https://blinktag.com')}>BlinkTag Inc</Text>{' '}
                with very large contributions from Jerry Jariyasunant and Brandon Martin-Anderson.
              </Text>
            </ScrollView>
